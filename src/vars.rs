...
pub const STAMINA_BASE: f32 = 100.0;
pub const STAMINA_PERSEC: f32 = 15.0;
pub const STAMINA_ATTACK: f32 = 25.0;
pub const STAMINA_EVADE: f32 = 10.0;
pub const STAMINA_NOEVADE: f32 = 10.0;
